...
Copyright (c) 2022 The TweetScraperPro Project  
'''
import sys
import os
import argparse
...
def options():
    """ Parse arguments
    """
    ap = argparse.ArgumentParser(prog="tweetscraperpro",
    ...
    ap.add_argument("--min-wait-time", type=float, default=15, help="specifiy a minimum wait time in case of scraping limit error. This value will be adjusted by tweetscraperpro if the value provided does not satisfy the limits constraints")
    args = ap.parse_args()

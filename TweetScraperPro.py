...
def options():
	ap = argparse.ArgumentParser(prog="tweetscraperpro.py", usage="python3 %(prog)s [options]", description="TWEETSCRAPERPRO - An Advanced Twitter Scraping Tool")
...
def main():
	...
	if args.favorites:
		tweetscraperpro.Favorites(c)
	elif args.following:
		tweetscraperpro.Following(c)
	elif args.followers:
		tweetscraperpro.Followers(c)
	else:
		tweetscraperpro.Search(c)
